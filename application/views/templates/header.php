...
<head>
  ...
  <!-- Template CSS -->
  <link rel="stylesheet" href="<?=base_url();?>design/assets/css/app.min.css">
  <link rel="stylesheet" href="<?=base_url();?>design/assets/bundles/datatables/datatables.min.css">
  <link rel="stylesheet" href="<?=base_url();?>design/assets/bundles/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.css">
