                        ...
                        <tbody>
                            ...
                            foreach($users as $user){
                                echo "<tr>";
                                    ...
                                    ?>
                                    <td align="center">
                                        <a href="#" class="btn btn-warning btn-sm editUser" data-toggle="modal" data-target="#ManageUser" data-id="<?=$user['id'];?>_<?=$user['username'];?>_<?=$user['password'];?>_<?=$user['fullname'];?>"><i class="fas fa-edit"></i></a>
